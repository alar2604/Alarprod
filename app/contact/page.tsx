             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
               ...
               <div className="bg-white">
                 <form className="space-y-6">
                   <div>
                     <label htmlFor="name" className="block text-sm font-medium text-neutral-700 mb-1">பெயர்</label>
                   ...
                   <div>
                     <label htmlFor="email" className="block text-sm font-medium text-neutral-700 mb-1">மின்னஞ்சல்</label>
                   ...
                   <div>
                     <label htmlFor="message" className="block text-sm font-medium text-neutral-700 mb-1">செய்தி</label>
